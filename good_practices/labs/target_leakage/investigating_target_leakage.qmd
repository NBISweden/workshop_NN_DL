---
title: 'Target leakage example: classifying text data (tweets)'
jupyter:
  jupytext:
    formats: ipynb,qmd
    text_representation:
  ...
  kernelspec:
    ...
    language: python
    name: python3
description: Target Leakage lab
notebook-url: '[investigating_target_leakage.ipynb](good_practices/labs/target_leakage/investigating_target_leakage.ipynb)'
---
...
#| editable: true
#| slideshow: {slide_type: ''}
fig = px.scatter(x=points_pca[:,0], y=points_pca[:,1], text=[word_dict[i] if i < 8000 else "" for i in range(n_words)], width=2400, height=800)
