...
cnn_model = ConvNet(input_channels=N_CHANNELS, n_classes=len(kept_labels), latent_dim=latent_dim)
optimizer = AdamW(cnn_model.parameters(), lr=1e-3, weight_decay=1e-5)
...
train(model=cnn_model, train_loader=train_loader, dev_loader=dev_loader, optimizer=optimizer, criterion=criterion, max_epochs=10, liveplot=liveplot)
```
