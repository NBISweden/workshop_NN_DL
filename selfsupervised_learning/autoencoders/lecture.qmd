...
subtitle: "Autoencoders and beyond"
author: "Erik Ylipää"
date: today
format:
  revealjs:
...
Most problems we want to solve are supervised: we often want to predict something based on known data.
...
Supervised learning requires data with labels.
...
## Deep learning learns representations from data
